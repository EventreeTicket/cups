...
<body class="dashboard-page">
  <main>
    <h1>RFID hardcups</h1>
    <p class="intro">Live-overzicht van uitgegeven hardcups. <a href="/history.php">Bekijk alle scan-historie</a> · <a href="/logs">Technische logs</a> · <a href="/api.php">Bekijk API-specificatie</a>.</p>
